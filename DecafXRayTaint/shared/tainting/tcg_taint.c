      ...
      case INDEX_op_deposit_i32: // Always bitwise taint
        ...
        if (arg0) {
          ...
          if(xt_enable_log_ir){
        	  ...
        	  if(arg2)
        		  XT_log_ir(arg2, orig2, 0, XT_encode_flag(TCG_DEPOSIT_i32, IR_SECOND_SOURCE) );
          }
#endif /* CONFIG_TCG_XTAINT */
          ...
          if(xt_enable_log_ir){
        	  ...
        	  if(arg2)
        		  XT_log_ir(arg2, 0, orig0, XT_encode_flag(TCG_DEPOSIT_i32, IR_SECOND_DESTINATION) );
          }
#endif /* CONFIG_TCG_XTAINT */
        }
        break;
...
#include "helper_i386_check.h"
      ...
      case INDEX_op_shr_i32: // Special - scalarShift()
        ...
        if (arg0) {
          ...
          if(xt_enable_log_ir){
        	  // 1st src: orig1; 2nd src: orig2(position)
        	  XT_log_ir(arg1, orig1, 0, XT_encode_flag(TCG_SHR, IR_FIRST_SOURCE) );
        	  XT_log_ir(arg2, orig2, 0, XT_encode_flag(TCG_SHR, IR_SECOND_SOURCE) );
          }
#endif /* CONFIG_TCG_XTAINT */
          ...
          if(xt_enable_log_ir){
        	  // dst: orig0
        	  XT_log_ir(arg1, 0, orig0, XT_encode_flag(TCG_SHR, IR_FIRST_DESTINATION) );
        	  XT_log_ir(arg2, 0, orig0, XT_encode_flag(TCG_SHR, IR_SECOND_DESTINATION) );
          }
#endif /* CONFIG_TCG_XTAINT */
      ...
      case INDEX_op_sar_i32: // Special - scalarShift()
        ...
        if (arg0) {
          ...
          if(xt_enable_log_ir){
        	  // 1st src: orig1; 2nd src: orig2(position)
        	  XT_log_ir(arg1, orig1, 0, XT_encode_flag(TCG_SAR, IR_FIRST_SOURCE) );
        	  XT_log_ir(arg2, orig2, 0, XT_encode_flag(TCG_SAR, IR_SECOND_SOURCE) );
          }
#endif /* CONFIG_TCG_XTAINT */
          ...
          if(xt_enable_log_ir){
        	  // dst: orig0
        	  XT_log_ir(arg1, 0, orig0, XT_encode_flag(TCG_SAR, IR_FIRST_DESTINATION) );
        	  XT_log_ir(arg2, 0, orig0, XT_encode_flag(TCG_SAR, IR_SECOND_DESTINATION) );
          }
#endif /* CONFIG_TCG_XTAINT */
      ...
      case INDEX_op_rotr_i32: // Special - MemCheck does lazy, but we shift
        ...
        if (arg0) {
          ...
          if(xt_enable_log_ir){
        	  // 1st src: orig1; 2nd src: orig2(position)
        	  XT_log_ir(arg1, orig1, 0, XT_encode_flag(TCG_ROTR, IR_FIRST_SOURCE) );
        	  XT_log_ir(arg2, orig2, 0, XT_encode_flag(TCG_ROTR, IR_SECOND_SOURCE) );
          }
#endif /* CONFIG_TCG_XTAINT */
          ...
          if(xt_enable_log_ir){
        	  // dst: orig0
        	  XT_log_ir(arg1, 0, orig0, XT_encode_flag(TCG_ROTR, IR_FIRST_DESTINATION) );
        	  XT_log_ir(arg2, 0, orig0, XT_encode_flag(TCG_ROTR, IR_SECOND_DESTINATION) );
          }
#endif /* CONFIG_TCG_XTAINT */
      ...
      case INDEX_op_mul_i32: // Up - mkUifU32(), mkLeft32(), mkPCastTo()
        ...
        if (arg0) {
          ...
          if(xt_enable_log_ir){
        	  // 1st src: orig1; 2nd src: orig2(position)
        	  if(arg1)
        		  XT_log_ir(arg1, orig1, 0, XT_encode_flag(TCG_MUL_i32, IR_FIRST_SOURCE) );
        	  if(arg2)
        		  XT_log_ir(arg2, orig2, 0, XT_encode_flag(TCG_MUL_i32, IR_SECOND_SOURCE) );
          }
#endif /* CONFIG_TCG_XTAINT */
          ...
          if(xt_enable_log_ir){
        	  // dst: orig0
        	  if(arg1)
        		  XT_log_ir(arg1, 0, orig0, XT_encode_flag(TCG_MUL_i32, IR_FIRST_DESTINATION) );
        	  if(arg2)
        		  XT_log_ir(arg2, 0, orig0, XT_encode_flag(TCG_MUL_i32, IR_SECOND_DESTINATION) );
          }
#endif /* CONFIG_TCG_XTAINT */
      ...
      case INDEX_op_and_i32: // Special - and_or_ty()
        ...
        if (arg0) {
          ...
          if(xt_enable_log_ir){
        	  // 1st src: orig1; 2nd src: orig2(position)
        	  if(arg1)
        		  XT_log_ir(arg1, orig1, 0, XT_encode_flag(TCG_AND_i32, IR_FIRST_SOURCE) );
        	  if(arg2)
        		  XT_log_ir(arg2, orig0, 0, XT_encode_flag(TCG_AND_i32, IR_SECOND_SOURCE) );
          }
#endif /* CONFIG_TCG_XTAINT */
          ...
          if(xt_enable_log_ir){
        	  // dst: orig0
        	  if(arg1)
        		  XT_log_ir(arg1, 0, orig2, XT_encode_flag(TCG_AND_i32, IR_FIRST_DESTINATION) );
        	  if(arg2)
        		  XT_log_ir(arg2, 0, orig2, XT_encode_flag(TCG_AND_i32, IR_SECOND_DESTINATION) );
          }
      ...
      */
      ...
      case INDEX_op_mulu2_i32: // Bytewise, mkLazyN()
        ...
        if (arg0 && arg1) {
          ...
          // Reinsert original opcode
          tcg_gen_op4_i32(INDEX_op_mulu2_i32, orig0, orig1, orig2, orig3);
      ...
      case INDEX_op_xor_i32: // In-Place - mkUifU32
        ...
        if (arg0) {
          ...
          if(xt_enable_log_ir){
        	  // 1st src: orig1; 2nd src: orig2(position)
        	  if(arg1)
        		  XT_log_ir(arg1, orig1, 0, XT_encode_flag(TCG_XOR_i32, IR_FIRST_SOURCE) );
        	  if(arg2)
        		  XT_log_ir(arg2, orig2, 0, XT_encode_flag(TCG_XOR_i32, IR_SECOND_SOURCE) );
          }

          // Reinsert original opcode
          tcg_gen_xor_i32(orig0, orig1, orig2);

          // log destination after operation
          if(xt_enable_log_ir){
        	  // dst: orig0
        	  if(arg1)
        		  XT_log_ir(arg1, 0, orig0, XT_encode_flag(TCG_XOR_i32, IR_FIRST_DESTINATION) );
        	  if(arg2)
        		  XT_log_ir(arg2, 0, orig0, XT_encode_flag(TCG_XOR_i32, IR_SECOND_DESTINATION) );
          }
      ...
      case INDEX_op_div_i32: // All-around: mkLazy2()
          ...
          if (arg0) {
            ...
            if(xt_enable_log_ir){
          	  // 1st src: orig1; 2nd src: orig2(position)
          	  if(arg1)
          		  XT_log_ir(arg1, orig1, 0, XT_encode_flag(TCG_DIV_i32, IR_FIRST_SOURCE) );
          	  if(arg2)
          		  XT_log_ir(arg2, orig2, 0, XT_encode_flag(TCG_DIV_i32, IR_SECOND_SOURCE) );
            }

            // Reinsert original opcode
            tcg_gen_div_i32(orig0, orig1, orig2);

            // log destination after operation
            if(xt_enable_log_ir){
          	  // dst: orig0
          	  if(arg1)
          		  XT_log_ir(arg1, 0, orig0, XT_encode_flag(TCG_DIV_i32, IR_FIRST_DESTINATION) );
          	  if(arg2)
          		  XT_log_ir(arg2, 0, orig0, XT_encode_flag(TCG_DIV_i32, IR_SECOND_DESTINATION) );
            }
      ...
      case INDEX_op_divu_i32: // All-around: mkLazy2()
          ...
          if (arg0) {
            ...
            if(xt_enable_log_ir){
          	  // 1st src: orig1; 2nd src: orig2(position)
          	  if(arg1)
          		  XT_log_ir(arg1, orig1, 0, XT_encode_flag(TCG_DIVU_i32, IR_FIRST_SOURCE) );
          	  if(arg2)
          		  XT_log_ir(arg2, orig2, 0, XT_encode_flag(TCG_DIVU_i32, IR_SECOND_SOURCE) );
            }

            // Reinsert original opcode
            tcg_gen_divu_i32(orig0, orig1, orig2);

            // log destination after operation
            if(xt_enable_log_ir){
          	  // dst: orig0
          	  if(arg1)
          		  XT_log_ir(arg1, 0, orig0, XT_encode_flag(TCG_DIVU_i32, IR_FIRST_DESTINATION) );
          	  if(arg2)
          		  XT_log_ir(arg2, 0, orig0, XT_encode_flag(TCG_DIVU_i32, IR_SECOND_DESTINATION) );
            }
      ...
      case INDEX_op_rem_i32: // All-around: mkLazy2()
          ...
          if (arg0) {
            ...
            if(xt_enable_log_ir){
          	  // 1st src: orig1; 2nd src: orig2(position)
          	  if(arg1)
          		  XT_log_ir(arg1, orig1, 0, XT_encode_flag(TCG_REM_i32, IR_FIRST_SOURCE) );
          	  if(arg2)
          		  XT_log_ir(arg2, orig2, 0, XT_encode_flag(TCG_REM_i32, IR_SECOND_SOURCE) );
            }

            // Reinsert original opcode
            tcg_gen_rem_i32(orig0, orig1, orig2);

            // log destination after operation
            if(xt_enable_log_ir){
          	  // dst: orig0
          	  if(arg1)
          		  XT_log_ir(arg1, 0, orig0, XT_encode_flag(TCG_REM_i32, IR_FIRST_DESTINATION) );
          	  if(arg2)
          		  XT_log_ir(arg2, 0, orig0, XT_encode_flag(TCG_REM_i32, IR_SECOND_DESTINATION) );
            }
      ...
      case INDEX_op_neg_i32:
        ...
        if (arg0) {
          ...
          if(xt_enable_log_ir){
        	  // 1st src: orig1; 2nd src: orig2(position)
        	  if(arg1)
        		  XT_log_ir(arg1, orig1, 0, XT_encode_flag(TCG_NEG_i32, IR_FIRST_SOURCE) );
          }

          // Reinsert original opcode
          tcg_gen_neg_i32(orig0, orig1);

          // log destination after operation
          if(xt_enable_log_ir){
        	  // dst: orig0
        	  if(arg1)
        		  XT_log_ir(arg1, 0, orig0, XT_encode_flag(TCG_NEG_i32, IR_FIRST_DESTINATION) );
          }
#endif /* CONFIG_TCG_XTAINT */
        }
        break;
